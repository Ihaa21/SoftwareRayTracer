...
extern "C" GAME_UPDATE_AND_RENDER(GameUpdateAndRender)
{
    ...
    if (!GameMem->IsInitialized)
    {
        ...
        // NOTE: Init camera
        GameState->Camera.Pos = V3(-10, 0, 0);
                 ...
                 ++ObjectIndex)
            {
                ...
                switch (Object->ModelType)
                {
                    case ModelType_Plane:
                    {
                        ...
                        if (RayPlaneIntersect(RayOrigin, RayDir, P, &t))
                        {
                    ...
                    case ModelType_Rect3:
                    {
                        ...
                        if (RayRectIntersect(RayOrigin, RayDir, R, &t))
                        {
                            v3 Phit = RayOrigin + t*RayDir;
                            //v3 Pnormal = ;
                    ...
                    case ModelType_Sphere:
                    {
                        ...
                        if (RaySphereIntersect(RayOrigin, RayDir, S, &t))
                        {
                            v3 Phit = RayOrigin + t*RayDir;
